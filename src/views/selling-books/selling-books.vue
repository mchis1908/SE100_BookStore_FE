        ...
        <div class="d-flex flex-row" style="height: calc( 100vh - 66px)">
                ...
                <div class="book-container" style="overflow-y: scroll; overflow-x: hidden; z-index:1">
                    <div class="book-item" v-for="(item, index) in books" :key="index">
                        ...
                        <img v-else src="@/assets/book-page/book-default.png"
                            style="height:120px; object-fit:contain;z-index:0" />
                        <div class="d-flex flex-column justify-content-center align-items-center"
                            style="gap:8px; height:100%; z-index:0">
            ...
            <div class="col-4 d-flex flex-column"
                ...
                <div class="input-field align-items-center" style="gap:16px">
                    <div class="d-flex justify-content-start align-items-center" style="font-weight:600; font-size:14px">
                        Customer:</div>
                    <input v-if="!selectCustomer" class="search-input input" placeholder="Enter customer information"
                ...
                <div style="position:relative">
                    <div v-if="customerInput && suggest?.length !== 0" class="text-start p-2 d-flex flex-column suggest">
                        <div class="d-flex flex-column" v-for="(item, index) in suggest" :key="index"
                            @click="handleSelectCustomer(item)" style="cursor:pointer; gap:8px">
                            <p
                ...
                <div class="input-field align-items-center" style="gap:16px">
                    ...
                    <div class="d-flex flex-column" style="gap:4px">
                        <select v-model="selectVoucher" class="input d-flex align-items-center"
                            style="padding:0 8px; height:40px">
                            <option :value="null" disabled selected>Select voucher</option>
                            <option style="height:30px" v-for="(item, index) in vouchers" :key="index" :value="item">
                                Name:{{ item?.name }} - Discount value: {{ item?.discountValue * 100 }}%</option>
                        </select>
                    </div>
                </div>
                <hr style="margin: 0; width:100%; border: 0.5px solid #E5E6E6; opacity: 1;" />
