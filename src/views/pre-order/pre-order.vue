                ...
                <div class="tab-content" id="pills-tabContent"
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                        ...
                        <div class="book-input-field"
                            style="width: 85%; padding: 12px; display: flex; gap: 16px; position: relative; margin-left: 5vw;">
                            <div class="book-input-pre-title" style="width: 12.5%">
                            ...
                            <div class="left-panel" style=" flex: 1; display: flex; flex-direction: column; gap: 5px;">
                                ...
                                <!-- Button Select All bên dưới -->
                                <button class="select-all-button"
                                    style="border-radius: 5px; width: 6vw; border: 0.5px solid #ccc" type="button">Select All</button>
                            </div>
                            ...
                            <div class="right-panel" style="flex: 1; display: flex; flex-direction: column;gap: 5px;">
                                ...
                                <!-- Select box -->
                                <select class="select-box" style="border-radius: 5px; padding: 4px;">
                                    <option value="option1">Option 1</option>
                                    <option value="option2">Option 2</option>
                                    <!-- Thêm các tùy chọn cho select box -->
                                </select>
                                <!-- Ô chữ nhật để hiển thị giá trị được tìm kiếm -->
                                <div class="search-result" style="flex: 1; border: 1px solid #ccc; border-radius: 5px;">
                                    <!-- Hiển thị kết quả tìm kiếm ở đây -->
                                </div>
                                <!-- Button Select All bên dưới -->
                                <button class="select-all-button"
                                    style="border-radius: 5px; width: 6vw; border: 0.5px solid #ccc">Select All</button>
                            </div>
                        </div>
                        <div class="input-field"
